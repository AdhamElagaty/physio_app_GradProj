...
import '../cubit/camera_cubit/camera_state.dart';
...
import '../cubit/exercise_session_cubit/exercise_session_state.dart';

class ExerciseCameraScreen extends StatefulWidget {
  final ExerciseTrainerType selectedExerciseType;
...
class _ExerciseCameraScreenState extends State<ExerciseCameraScreen> {
  ...
  String _formatExerciseName(ExerciseTrainerType type) {
    return type
        .toString()
        .split('.')
        .last
