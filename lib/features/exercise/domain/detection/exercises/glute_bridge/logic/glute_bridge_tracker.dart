...
import '../../../../../../../core/services/model_inference_processor_service/feature_model_processor_impl.dart';
...
class GluteBridgeTracker extends BodyTracker {
  ...
  final FeatureModelProcessorImpl _modelProcessor;
  ...
  GluteBridgeTracker()
      : _featureExtractor = GluteBridgeFeatureExtractor(),
        _modelProcessor = FeatureModelProcessorImpl(modelPath: _modelPath),
