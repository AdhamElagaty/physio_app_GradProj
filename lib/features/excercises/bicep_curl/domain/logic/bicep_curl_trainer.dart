...
import '../../presentation/painters/bicep_curl_pose_painter.dart';
...
class BicepCurlTrainer extends ExerciseTrainer {
  ...
  String getInstructions() {
    log("BicepCurlTrainer: getInstructions called. Current goal: ${_repGoalConfig.currentGoal}, Auto-increase: ${_repGoalConfig.autoIncreaseEnabled}");
    String autoIncrementNote = _repGoalConfig.autoIncreaseEnabled
        ? "\nAuto-progression: ON (Goal increases upon completion)"
        : "";
...
2. Hold weights by your sides, arms extended.
3. Keep elbows close to your body.
4. Curl weights up by bending elbows.
5. Squeeze biceps at the top.
6. Lower weights with control.
7. Current Rep Goal: ${_repGoalConfig.currentGoal} total reps.$autoIncrementNote

TIPS:
• Keep back straight. Don't swing.
