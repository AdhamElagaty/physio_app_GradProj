...
import '../../../../model_inference/services/scaled_feature_model_processor.dart';
...
class BicepArmTracker extends BodyTracker {
  ...
  final ScaledFeatureModelProcessor _modelProcessor;
  ...
  BicepArmTracker(this.side)
      : _featureExtractor = BicepCurlFeatureExtractor(side),
        _modelProcessor = ScaledFeatureModelProcessor(
