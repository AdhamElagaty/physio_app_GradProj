...
import '../../presentation/painters/glute_bridge_pose_painter.dart';
...
1. Lie on your back, knees bent, feet flat, hip-width apart. Arms by sides, palms down.
2. Engage core & glutes, lift hips: straight line shoulders to knees.
3. Squeeze glutes at the top. Avoid arching your lower back.
4. Hold for the cued duration (aim for at least ${GluteBridgeTracker.minHoldTimeForRep.toStringAsFixed(1)}s, ideally ${GluteBridgeTrainer.correctHoldTimeGoalDisplay.toStringAsFixed(1)}s or more!).
5. Slowly lower hips with control.
6. Current Rep Goal: ${_repGoalConfig.currentGoal} reps.
7. Current Max Hold Goal: ${_holdGoalConfig.currentGoal.toStringAsFixed(1)} seconds for a single hold.

TIPS:
• Keep neck relaxed. Push through heels.
• Knees aligned with hips & ankles.
